...
namespace metroidvania
{
    ...
    public class ledgelocator : ability
    {
        ...
        */
        ...
        protected virtual void CheckForLedge()
        {
            ...
            if (!Falling)
            {
                ...
                if (ledge != null && character.grabbingLedge)
                {
                    ...
                    GetComponent<horizontalmove>().enabled = false;
                }
                ...
                if (ledge == null && !character.grabbingLedge && !character.isonladder)
                {
                    ...
                    GetComponent<horizontalmove>().enabled = true;
        ...
        protected virtual void LedgeHanging()
        {
            ...
            if (character.grabbingLedge && (Input.GetAxis("Vertical") > 0||input.Upheld()))
            {
            ...
            if (character.grabbingLedge && (Input.GetAxis("Vertical") < 0||input.Downheld()))
            {
                ledge = null;
                moved = false;
